...
> **New:** Step-by-step setup for Cursor, Claude Code, Copilot, and more — see **[Agent setup guide](agent-setup.md)**.  
...
See [Agent setup guide](agent-setup.md) for every supported agent.
