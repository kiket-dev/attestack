...
import problemSvg from '../../assets/img/problem-scattered.svg?raw';
import flowSvg from '../../assets/img/attestack-flow.svg?raw';
import hashSvg from '../../assets/img/hash-chain.svg?raw';
import loopSvg from '../../assets/img/session-loop.svg?raw';
