---
title: "Use cases"
description: "Who Attestack is for and what problems it solves."
---
...
GitHub Actions (or other CI) runs tests inside an Attestack session, exports a bundle, and uploads it as a workflow artifact. See [CI integration](/integrations/ci/).
